<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="24" :sm="24" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('gpsChartData')">
    ...
    <el-col :xs="24" :sm="24" :lg="8" class="card-panel-col">
      <div
        class="card-panel"
        @click="handleSetLineChartData('vehicleChartData')"
      >
    ...
    <el-col :xs="24" :sm="24" :lg="8" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('alarmChartData')">
